  ...
  return (
    <div>
      ...
      text-white p-3 uppercase"
            ...
            <div className="mt-[20px] pl-3 flex flex-row items-center flex-wrap gap-[14px]">
              <div
      ...
      text-white p-3 uppercase"
            ...
            <div className="mt-[20px]">
              <p
                className="mt-[4px] font-epilogue 
            font-normal text-[12px] text-[#808191] leading-[26px] text-justify pl-3"
              >
                {state.description}
              </p>
            </div>
      ...
      text-white p-3 uppercase"
            ...
            <div className="mt-[20px] flex flex-col gap-4">
              {donators.length > 0 ? (
                ...
                <p
                  className="font-epilogue pl-3 font-normal 
      ...
      text-white p-3 uppercase"
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]">
            <p
              className="font-epilogue font-medium text-[20px] leading-[30px]
            ...
            <div className="mt-30px">
              ...
              <div className="my-[20px] p-4 bg-[#13131a] rounded-[10px]">
                ...
                <p className="mt-[20px] font-epilogue font-normal leading-[22px] text-[#808191]">
                  Support the product for no reward, just because it speaks to
                  you
                </p>
              </div>
